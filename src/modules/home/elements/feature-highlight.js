...
const FeatureHighlight = () => {
  return (
    <div className="text-center md:flex md:text-left md:min-h-[55hv] items-center bg-[#9399f4] p-5">
      ...
      <div className="md:w-[50%]">
        ...
        <br />
        <p className="text-cyber-ink text-xl md:text-2xl max-w-lg font-normal mb-5">
          <strong>Warning:</strong> A writing experience unlike anything you&lsquo;ve ever
          experienced - proceed with caution.
        </p>
        <Button className="bg-white border-2 border-black rounded text-2xl !p-7 !px-16">
          Start Building
        </Button>
      </div>
    </div>
